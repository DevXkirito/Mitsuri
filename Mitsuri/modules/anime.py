...
*Anime Search Commands:*
   × `/est`*:* search an Anime on estanime.com website.
   × `/hsa`*:* search an Anime on hsaanime.com website.
   × `/classic <search input>`*:* search anime on Classic Anime.
   × `/air <search input>`*:* search anime on Anime Air.
